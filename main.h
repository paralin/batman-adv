...
/* length of the single packet used by the BW meter */
#define BATADV_BW_PACKET_LEN ETH_DATA_LEN
...
/**
 * BATADV_BW_MAX_NUM - maximum number of simultaneously active bw sessions
 */
#define BATADV_BW_MAX_NUM 5
 ...
 * @BATADV_DBG_BW_METER: bandwidth meter messages
