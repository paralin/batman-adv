...
/* Use this, if you are going to set [name] in hard_iface to unsigned integer
 * values only */
...
BAT_ATTR_UINT(ndp_min_len, S_IRUGO | S_IWUSR, 0, ETH_DATA_LEN, NULL);
